...
const Navbar = () => {
    ...
    return (
        <div>
            <header className="p-4 bg-gray-800 text-red-800">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className={`items-stretch space-x-3 absolute lg:static top-24 left-48 space-y-5 lg:space-y-0 p-5 w-36 border-2 lg:border-0 lg:flex ${open ? 'hidden' : 'block'}`}>
                        ...
                        <div className="items-center flex-shrink-0 block lg:hidden">
                            <button className="self-center px-3 lg:px-8 py-3 rounded">Sign in</button>
                            <button className="self-center px-3 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900">Sign up</button>
