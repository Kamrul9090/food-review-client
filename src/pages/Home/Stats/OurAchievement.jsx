...
const OurAchievement = () => {
    return (
        <div className='py-20'>
            <section className="p-6 my-6 bg-gray-200 dark:bg-gray-800 dark:text-gray-100">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 dark:bg-gray-900 bg-gray-300 dark:text-gray-100">
