    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-6xl mx-auto py-10 dark:bg-gray-900 dark:text-gray-100 text-blue-900 mb-20 px-5'>
            <div className='relative'>
                <img src={img1} alt="" secSet="" className='h-3/4 w-full lg:w-3/4' />
                <img src={img3} alt="" secSet="" className='w-1/2 absolute top-80 left-40 lg:left-64 rounded-3xl shadow-2xl shadow-slate-400 border-4 border-gray-200' />
            </div>
