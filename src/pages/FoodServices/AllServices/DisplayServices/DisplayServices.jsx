        ...
        <>
            <AnimationOnScroll initiallyVisible={true} animateIn="animate__backInUp">
                ...
                <div className='flex justify-center mt-10'>
                    <Link to="/AllServices"><button class="mt-4 w-52 dark:bg-green-500 dark:hover:bg-blue-900 bg-blue-900  hover:bg-green-500 text-white py-2 px-4 rounded transition-colors duration-300">See All</button></Link>
                </div>
            </AnimationOnScroll>
        </>
    );
